...
FEE_REGISTRY_VENUE = {
    ...
    "bybit": "bybit",  # pas encore dans configs/alpha20.yaml assumed_defaults ->
                        # fee_registry retombe sur binance_usdm par défaut ; à
                        # corriger séparément si le fallback silencieux gêne.
}
