#!/usr/bin/env python3
"""
legacy.train_local — entraînement local legacy sur CSV enrichi
==============================================================
...
Usage :
    ...
    python train.py local --data data/BTCUSD_1h_features.csv --skip-event
    python train.py local --data data/ --out runs/legacy/local
    python train.py local --data data/BTCUSD_1h_features.csv --years 2022,2023,2024
"""
...
def parse_args():
    ...
    ap.add_argument(
        "--out",
        default=str(SETTINGS.paths.local_runs_dir),
        help=f"Dossier de sortie (défaut : {SETTINGS.paths.local_runs_dir})",
    )
    ap.add_argument(
        "--years",
        default=None,
