# PRE-BINANCE VENUE TAPE — coverage (2026-09-12T14:57:00 UTC)
...
| okx | route_documented_not_collected | {'not_collected': 8} | free; `GET https://www.okx.com/api/v5/market/history-candles?instId=<BASE>-USDT&bar=1D|…` |
| bybit | route_documented_not_collected | {'not_collected': 10} | free; `GET https://api.bybit.com/v5/market/kline?category=spot&symbol=<BASE>USDT&interv…` |
| kucoin | route_documented_not_collected | {'not_collected': 6} | free; `GET https://api.kucoin.com/api/v1/market/candles?symbol=<BASE>-USDT&type=1day|1h…` |
