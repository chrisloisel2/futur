...
| okx | BTCUSDT | 0.01 bps | 120 ms | 0.10 / 0.28 | 0.50 | 0.57 − 0.01 = 0.56 | 0.37 | 10.55 / 4.55 | 5.12 / 2.72 |
| okx | ETHUSDT | 0.04 bps | 120 ms | 0.06 / 0.36 | 0.56 | 0.45 − 0.02 = 0.43 | 0.41 | 10.72 / 4.72 | 4.86 / 2.46 |
| okx | SOLUSDT | 0.96 bps | 120 ms | 0.48 / 0.66 | 0.92 | 0.39 − 0.48 = -0.10 | 0.30 | 11.33 / 5.33 | 3.81 / 1.41 |
| hyperliquid | BTCUSDT | 0.13 bps | 332 ms | 0.06 / 0.24 | 0.64 | 0.40 − 0.11 = 0.29 | 0.24 | 9.48 / — | 3.59 / -0.01 |
| hyperliquid | ETHUSDT | 0.40 bps | 333 ms | 0.20 / 0.46 | 0.68 | 0.59 − 0.26 = 0.33 | 0.17 | 9.91 / — | 3.66 / 0.06 |
| hyperliquid | SOLUSDT | 0.96 bps | 333 ms | 0.48 / 0.68 | 0.71 | 0.55 − 0.55 = 0.00 | 0.16 | 10.36 / — | 3.01 / -0.59 |

| venue | maker VIP0 / best | taker VIP0 / best | tier « best » | ce que le tier exige |
|---|---|---|---|---|
| binance | 2.0 / 0.0 | 5.0 / 1.7 | VIP9 | 30 G USD de volume futures sur 30 j ET 5 500 BNB en solde moyen |
| okx | 2.0 / 0.8 | 5.0 / 2.0 | VIP8 (sommet du bareme standard) | ~2 G USDT de volume sur 30 j (VIP8) ; le rebate maker -0,5 bps est un programme market-maker hors bareme, seuil non source |
| bybit | 2.0 / 0.0 | 5.5 / 1.8 | Pro 6, top-72 contrats | 5 G USD de derives par mois (Pro 6) |
| hyperliquid | 1.5 / -0.3 | 4.5 / — | MM tier 3 (>3 % du volume maker de la plateforme) | > 3 % du volume maker total de la plateforme sur 14 j |
...
- **microstructure au meilleur tier publié : OUI** — binance/SOLUSDT/best/maker, hyperliquid/BTCUSDT/best/maker, hyperliquid/ETHUSDT/best/maker, hyperliquid/SOLUSDT/best/maker
- conditions de la réouverture : maker-only, tiers à rebate (binance/SOLUSDT/best/maker : VIP9, P(fill 30 s) 0.41, ½-spread gagné 0.48 bps contre dérive perdue 0.17 bps; hyperliquid/BTCUSDT/best/maker : MM tier 3 (>3 % du volume maker de la plateforme), P(fill 30 s) 0.24, ½-spread gagné 0.11 bps contre dérive perdue 0.40 bps; hyperliquid/ETHUSDT/best/maker : MM tier 3 (>3 % du volume maker de la plateforme), P(fill 30 s) 0.17, ½-spread gagné 0.26 bps contre dérive perdue 0.59 bps; hyperliquid/SOLUSDT/best/maker : MM tier 3 (>3 % du volume maker de la plateforme), P(fill 30 s) 0.16, ½-spread gagné 0.55 bps contre dérive perdue 0.55 bps)
- **cross-exchange (jambe disloquée prise en taker + jambe posée en maker) : NON** — plus bas aller-retour deux jambes : binance/SOLUSDT/best 4.09 bps, binance/BTCUSDT/best 5.22 bps, binance/ETHUSDT/best 5.35 bps
...
- plus bas aller-retour maker au meilleur tier publié : binance/SOLUSDT -0.62 bps, hyperliquid/SOLUSDT -0.59 bps, hyperliquid/BTCUSDT -0.01 bps
...
| okx/SOLUSDT/best/maker | 4.22 |
| okx/ETHUSDT/best/maker | 7.37 |
| okx/BTCUSDT/best/maker | 8.15 |
