...
echo ""
echo "Models saved:"
echo "  - Regime (BINARY): artifacts/models/regime/production_binary_v1.pkl"
...
echo ""
echo "Metrics:"
echo "  - Regime: artifacts/models/regime/production_binary_v1_metrics.json"
echo "  - Edge:   artifacts/models/edge/production_v1_metrics.json"
echo ""
echo "Quick validation:"
echo "  - Regime accuracy:  cat artifacts/models/regime/production_binary_v1_metrics.json | grep accuracy"
echo "  - Calm recall:      cat artifacts/models/regime/production_binary_v1_metrics.json | grep -A 1 'calm'"
echo "  - Reversal recall:  cat artifacts/models/regime/production_binary_v1_metrics.json | grep -A 1 'reversal'"
